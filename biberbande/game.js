...
const play = (game) => {
	...
	*/
        var logInfo1 = "Computer hat die Karten " + computer + "mit einer Summe von " + computerPoints;
        var logInfo2 = ". Du hast die Karten " + player + "mit einer Summe von "+ playerPoints + ". \n";
